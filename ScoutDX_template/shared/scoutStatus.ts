export const SCOUT_STATUS = {
  ...
  REJECTED_BY_ADMIN_TO_APPROVER: "REJECTED_BY_ADMIN_TO_APPROVER",
  REJECTED_BY_ADMIN_TO_ADMIN: "REJECTED_BY_ADMIN_TO_ADMIN",
  AVAILABLE: "AVAILABLE",
} as const;
...
export const SCOUT_STATUS_LABEL: Record<ScoutStatus, string> = {
  DRAFT: "下書き",
  PENDING_APPROVER: "承認者の承認待ち",
  REJECTED_BY_APPROVER: "承認者差戻し",
  PENDING_ADMIN: "管理者の承認待ち",
